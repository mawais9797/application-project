...
import penNib from "../images/pen-24-up.png";
    ...
    >
      <Box className={classes.boxContainer}>
        <FormControl className={classes.clientSelect} color="myBorderColor">
          <InputLabel id="client-select-label" className={classes.selectLabel}>
            Client name
          </InputLabel>
          <Select
        ...
        <FormControl className={classes.clientSelect} color="myBorderColor">
          <InputLabel id="project-select-label" className={classes.selectLabel}>
            Project title
          </InputLabel>
          <Select
          ...
          <List className={classes.TeamList}>
            ...
            <ListItem className={classes.TopbarSettings}>
              ...
              <img
                ...
                alt="penNib"
                style={{ zIndex: "2" }}
                className={classes.TeamImagesAuthor}
              />
            </ListItem>
          </List>
        </Box>
